...
class CoreSet(Strategy):
	def __init__(self, X, Y, idxs_lb, net, handler, args, tor=1e-4, X_val=None, Y_val=None):
		super(CoreSet, self).__init__(X, Y, idxs_lb, net, handler, args, X_val=X_val, Y_val=Y_val)
		self.tor = tor
	...
	def query(self, n, pool_size=2000):
		...
		# sh /u/zc9uy/gurobi912/linux64/bin/gurobi.sh < ./query_strategies/core_set_solve.py
		os.system('sh /u/zc9uy/gurobi912/linux64/bin/gurobi.sh < ./query_strategies/core_set_solve.py')
